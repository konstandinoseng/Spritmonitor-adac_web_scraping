...
class LinksSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.spritmonitor.de/en/overview/0-All_manufactures/0-All_models.html?vehicletype=1&constyear_s=2020&constyear_e=2022&page=25']
    base_url = 'https://www.spritmonitor.de/en'
    ...
    def parse(self, response):
        ...
        for link in links:
            yield{
                'link': str(response.css('td.description a::attr(href)'))
                }
